    ...
    <div class="login-container">
        ...
        <main class="main-content">
            <section class="hero-section">
                <h2 class="hero-title">Create A New Wallet</h2>
            </section>
            ...
            <section class="login-section">
                <form @submit.prevent="handleSubmit">
                    ...
                    <p>Already registered? <router-link to="/">Click here to connect to your wallet</router-link></p>
...
export default {
    ...
    methods: {
        async handleSubmit() {
            try {
                const response = await api.post('/api/create_wallet', {
                    wallet_name: this.walletname,
                    wallet_key: this.password,
                });
                if (response.status !== 200) {
                    this.errorMessage = 'Register failed. Please check your wallet name and key.';
                    return;
                }
